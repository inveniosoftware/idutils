...
identifiers = [
    ...
    (
        "https://dx.doi.org/10.1016/j.epsl.2011.11.037",
        [
            "doi",
            "url",
        ],
    ...
    ("10013/epic.10033", ["handle"], "", "https://hdl.handle.net/10013/epic.10033"),
    (
    ...
    ("12082125", ["pmid"], "12082125", "https://pubmed.ncbi.nlm.nih.gov/12082125"),
    ("pmid:12082125", ["pmid"], "12082125", "https://pubmed.ncbi.nlm.nih.gov/12082125"),
    (
    ...
    ("PMC2631623", ["pmcid"], "", "https://www.ncbi.nlm.nih.gov/pmc/PMC2631623"),
    (
        "2011ApJS..192...18K",
        ["ads"],
        "",
    ...
    (
        ...
        ["ads"],
        "2017zndo....495787v",
        "https://ui.adsabs.harvard.edu/#abs/2017zndo....495787v",
    ),
    (
        "0000000218250097",
        ["orcid", "isni"],
    ...
    (
        ...
        ["orcid", "isni"],
        "0009-0005-6000-7479",
        "https://orcid.org/0009-0005-6000-7479",
    ),
    (
    ...
    (
        ...
        "",
        "https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GPL9",
    ),
    (
        "GSM888",
        [
        ...
        "",
        "https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSM888",
    ),
    (
        "GSE55396",
        [
        ...
        "",
        "https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE55396",
    ),
    (
        "GDS1234",
        [
    ...
    (
        ...
        "",
        "https://www.ebi.ac.uk/arrayexpress/arrays/A-MEXP-1171",
    ),
    (
        "A-AFFY-17",
        [
        ...
        "",
        "https://www.ebi.ac.uk/arrayexpress/arrays/A-AFFY-17",
    ),
    (
        "E-MEXP-1712",
        [
    ...
    (
        ...
        "",
        "https://www.ebi.ac.uk/arrayexpress/experiments/E-MTAB-424",
    ),
    (
        "E-MTAB-4020",
        [
        ...
        "",
        "https://www.ebi.ac.uk/arrayexpress/experiments/E-MTAB-4020",
    ),
    (
        "E-TABM-14",
        [
        ...
        "",
        "https://www.ebi.ac.uk/arrayexpress/experiments/E-TABM-14",
    ),
    (
        "E-FLYC-6",
        [
        ...
        "",
        "https://www.ebi.ac.uk/arrayexpress/experiments/E-FLYC-6",
    ),
    (
        "hal:inserm-13102590",
        [
    ...
    ("03yrm5c26", ["ror"], "03yrm5c26", "https://ror.org/03yrm5c26"),
    (
...
def test_to_url():
    ...
    for i, expected_schemes, normalized_value, url_value in identifiers:
        ...
        assert idutils.to_url(
            ...
            url_value.replace("https://", "http://", 1)
            # If the value is already a URL its scheme is preserved
            if expected_schemes[0] not in ["purl", "url", "viaf"]
            else url_value
        )
